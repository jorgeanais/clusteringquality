# Title     : Performing some quality clusterings
# Objective : TODO
# Created by: jorge
...
results.photpm <- cluster.stats(d.photpm, label.photpm)
...
results.colorspm <- cluster.stats(d.colorspm, label.colorspm)
...
results.allin <- cluster.stats(d.allin, label.allin)
...
results.mini <- cluster.stats(d.mini, label.mini)
...
results.minialt <- cluster.stats(d.minialt, label.minialt)
